...
public class footballpostget {
    ...
    public interface Interpost {
        ...
        @GET("?action=get_H2H")
        Call<List<H2hpost>> getpost(@Query("firstTeam") String firstTeam,@Query("secondTeam") String secondTeam,@Query("APIkey") String APIkey);
       // Call<H2hpost> getpost();
